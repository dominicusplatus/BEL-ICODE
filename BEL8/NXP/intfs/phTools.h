...
*/
/*@{*/
#define PH_TOOLS_Q_MAX_ELEMENTS        12    /* Indicates Maximum elements in the Q pool */
...
typedef struct phTools_Q
{
    ...
    phTools_Q_Type_t bType;           /**< Message content type. SYMM timer OR Data to be sent OR Timeout. */
} phTools_Q_t;
...
/**
* \brief Queue a message to the Message send queue list.
*
