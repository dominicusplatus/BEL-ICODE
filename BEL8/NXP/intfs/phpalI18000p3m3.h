...
* $Revision: 3068 $ (NfcRdLib_A_Gate_Incremental_V3.092.04.001533 : 3050 )
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT

/** \defgroup phpalI18000p3m3_DUT Component : DUT
* @{
*/

#define PHPAL_I18000P3M3_DUT_ID  0x0B   /**< ID for DUT I18000P3M3 layer. */

/**
* \brief DUT PAL-I18000P3M3 parameter structure
*/

typedef struct
{
    uint16_t wId;                                   /**< Layer ID for this component, NEVER MODIFY! */
    phhalHw_DUT_DataParams_t * pHalDataParams;    /**< Pointer to the parameter structure of the underlying layer. */
}phpalI18000p3m3_DUT_DataParams_t;
...
* \retval #PH_ERR_SUCCESS Operation Successful.
*/
phStatus_t phpalI18000p3m3_DUT_Init(
                                      phpalI18000p3m3_DUT_DataParams_t * pDataParams,   /**< [IN] Pointer to this layer's parameter structure. */
                                      uint16_t wSizeOfDataParams,                         /**< [IN] Specifies the size of the data parameter structure. */
                                      void * pHalDataParams                               /**< [IN] Pointer to the parameter structure of the underlying layer. */
                                      );
/** @} */
#endif /* NXPBUILD__PHPAL_I18000P3M3_DUT */
...
/**
* \name Link Frequencies
*/
/*@{*/
#define PHPAL_I18000P3M3_LF_423KHZ  0x00U   /**< 423kHz (fc/32). */
#define PHPAL_I18000P3M3_LF_847KHZ  0x01U   /**< 847kHz (fc/16). */
/*@}*/
...
*/
/*@{*/
#define PHPAL_I18000P3M3_M_MANCHESTER_2     0x02U   /**< 2 sub-carrier pulse Manchester. */
#define PHPAL_I18000P3M3_M_MANCHESTER_4     0x03U   /**< 4 sub-carrier pulse Manchester. */
/*@}*/
...
#define phpalI18000p3m3_ActivateCard(pDataParams, pSelCmd, bSelCmdLen, bNumValidBitsinLastByte, pBeginRndCmd, \
                                     bTSprocessing, ppRxBuffer, wRxBufferLen, pMoreCardsAvailable) \
...
* \li #PHPAL_I18000P3M3_ACK_USE_CRC
