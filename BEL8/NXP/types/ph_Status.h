...
#define PH_ERR_RF_ERROR                 0x000AU /**< Error occurred if Active Timing is not met during Active Communication. */
...
#define PH_ERR_RF_TURNOFF               0x0013U /**< External RF turned OFF during Autocoll. */
