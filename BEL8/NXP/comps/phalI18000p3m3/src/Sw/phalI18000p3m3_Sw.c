...
* $Revision: 3068 $ (NfcRdLib_A_Gate_Incremental_V3.092.04.001533 : 2696 )
                                 ...
                                 )
{
    ...
    else
    {
        ...
        {
            status = PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_AL_I18000P3M3);
        }
                                   ...
                                   )
{
    ...
    if (bOption == PHAL_I18000P3M3_REQRN_USE_CRC)
    {
        ...
        /* Store new Handle */
        memcpy(pDataParams->abHandle, *ppRxBuffer, wRxByteLength);  /* PRQA S 3200 */
    }
#endif /* NXPBUILD__PHPAL_I18000P3M3_DEPRECATED */
