...
#include "DUT/phpalI18000p3m3_DUT.h"
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_Exchange(
            (phpalI18000p3m3_DUT_DataParams_t *)pDataParams,
            wOption,
            pTxBuffer,
            wTxLength,
            bTxLastBits,
                                  ...
                                  )
{
    ...
    if (bMaskBitLength != 0) PH_ASSERT_NULL (pMask);
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_Select(
            (phpalI18000p3m3_DUT_DataParams_t *)pDataParams,
            bTarget,
            bAction,
            bMemBank,
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_BeginRound(
            (phpalI18000p3m3_DUT_DataParams_t *)pDataParams,
            bDr,
            bM,
            bTRext,
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_ResizeRound(
            (phpalI18000p3m3_DUT_DataParams_t *)pDataParams,
            bUpDn,
            pStoredCRC);
        break;
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_NextSlot(
            (phpalI18000p3m3_DUT_DataParams_t *)pDataParams,
            pStoredCRC);
        break;
#endif /* NXPBUILD__PHPAL_I18000P3M3_DUT */
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_GetSerialNo(
            (phpalI18000p3m3_DUT_DataParams_t *) pDataParams,
            pRxBuffer,
            pRxLength);
        break;
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_Ack(
            (phpalI18000p3m3_DUT_DataParams_t *)pDataParams,
            bOption,
            pHandle,
            ppRxBuffer,
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_Nak((phpalI18000p3m3_DUT_DataParams_t *)pDataParams);
        break;
#endif /* NXPBUILD__PHPAL_I18000P3M3_DUT */
...
#ifdef NXPBUILD__PHPAL_I18000P3M3_DUT
    case PHPAL_I18000P3M3_DUT_ID:
        status = phpalI18000p3m3_DUT_SetConfig(
            (phpalI18000p3m3_DUT_DataParams_t *)pDataParams,
            wConfig,
            wValue);
        break;
